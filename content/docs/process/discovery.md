...
- **An Opportunity Solution Tree** — a single page with four layers: Outcome (the customer value we are after), Opportunities (customer needs, pains, desires), Solutions (candidate approaches), Assumption tests (the smallest thing we can do to learn whether a solution is worth building).
